...
\def\papertitle{Templates for One Author}
...
%\setcounter{page}{1}
\input{../../expages.tex}\setpagenumber{01}
\ninept
...
{\href{http://www.music.mcgill.ca/~mtech/spcl/}{SPCL, Music Technology Area}\\ McGill University, Montreal, Canada \\ 
{\tt \href{mailto:dafx06@dafx.ca}{dafx06@dafx.ca}}
}
...
The references will be numbered in order of appearance \cite{Serra:1996:sms,Moorer:2000:AES:audio:millenium,Arfib:1998:DAFx,Mitra:Kaiser:1993:DSP:handbook}. Please avoid listing references that do not appear in the text.
