...
\def\papertitle{Templates f\'or F\`o\"ur \`Authors}
\def\paperauthorA{J\o{}hn J\"oe}
\def\paperauthorB{K\'e\~{n}t K\^{\i}ng}
\def\paperauthorC{L\`ou L\'ou}
\def\paperauthorD{M\`anfr\'ed J. M\^ost\u{e}k\i}
...
%\setcounter{page}{1}
\input{../../expages.tex}\setpagenumber{05}
\ninept
...
\fouraffiliations{\paperauthorA, \sthanks{This work was supported by the XYZ Foundation}}
...
{\href{http://www.dafx.ca}{Unknown Group, Dept.~of Volatile Sciences} \\ Univ.~of Nowhere, Somewhere \\ {\tt \href{mailto:dafx06@dafx.ca}{dafx06@dafx.ca}}
}
...
The references will be numbered in order of appearance \cite{Serra:1996:sms,Moorer:2000:AES:audio:millenium,Dutilleux:1991,Fitz:Haken:2003:Web:morphing:loris}. Please avoid listing references that do not appear in the text.
