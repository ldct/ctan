...
%\setcounter{page}{1}
\input{../../expages.tex}\setpagenumber{03}
\ninept
...
\twoaffiliations{\paperauthorA}
{\href{http://www.music.mcgill.ca/~mtech/spcl/}{SPCL, Music Technology Area}\\ Schulich School of Music\\ McGill University, Montreal, Canada \\ {\tt \href{mailto:dafx06@dafx.ca}{dafx06@dafx.ca}}
}
{\paperauthorB}
{\href{http://dafx05.ssr.upm.es}{Signal Processing Applications Group} \\ Dept.~SSR, ETSI Telecomunicacion\\ UPM, Madrid, Spain \\ 
  {\tt \href{mailto:dafx05@ssr.upm.es}{dafx05@ssr.upm.es}}
}
