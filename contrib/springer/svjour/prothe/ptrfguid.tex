...
for\\Probability Theory and Related Fields}
...
\label{sec:intro}
This document describes the \textit{probth} option for the \SJour\
...
\texttt{http://link.springer.de/link/service/journals/00440/index.htm}
...
begin a document for \emph{Probability Theory and Related Fields} by
including
\begin{verbatim}
