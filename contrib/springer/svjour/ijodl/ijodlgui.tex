...
\title{The \SJour\ document class users guide\\supplement for the\\
\textit{International Journal on Digital Libraries (IJODL)}}
...
\label{sec:intro}
This document describes the \textit{ijodl} option for the
...
the \emph{International Journal on Digital Libraries} by including
\begin{verbatim}
   \documentclass[ijodl]{svjour}
\end{verbatim}
