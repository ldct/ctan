...
\label{sec:intro}
This document describes the \textit{sct} option for the
...
begin a document for \emph{Software Concepts \& Tools} by including
\begin{verbatim}
   \documentclass[sct]{svjour}
\end{verbatim}
