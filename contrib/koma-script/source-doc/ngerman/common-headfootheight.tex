...
\IfThisCommonLabelBase{scrlayer-scrpage}{%
  ...
  \autopageref{tab:scrlayer.layerkeys}). Deshalb muss die Höhe beider Elemente
  bekannt sein.%
}
...
Optionen \DescRef{typearea.option.footheight} und
...
versucht\IfThisCommonLabelBase{scrlayer-scrpage}{}{ beispielsweise}
