...
\IfThisCommonFirstRun{}{%
  ...
  \autoref{sec:\ThisCommonFirstLabelBase.fontOptions} geschrieben
  ...
  verstanden haben, können Sie \IfThisCommonLabelBase{scrlttr2}{beim Beispiel
    ...
    \IfThisCommonLabelBase{letzten Absatz }{}%
  }%
  am Ende dieses Abschnitts auf
  \autopageref{sec:\ThisCommonLabelBase.fontOptions.end} fortfahren.%
}
...
\DescPageRef{typearea.cmd.recalctypearea}). Wird diese Neuberechnung
...
%  \end{captionbeside}
  ...
  \IfThisCommonLabelBase{maincls}{%
    ...
    Standardklassen zu den \KOMAScript-Klassen gegebenenfalls zu beachten.%
  }{}%
}%
\EndIndexGroup
%
