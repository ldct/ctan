...
\IfThisCommonFirstRun{}{%
  ...
  \autoref{sec:\ThisCommonFirstLabelBase.footnotes} geschrieben wurde. Falls
  Sie also \autoref{sec:\ThisCommonFirstLabelBase.footnotes} bereits gelesen
...
\IfThisCommonLabelBase{maincls}{%
  Im Unterschied zu den Standardklassen bietet \KOMAScript{} die Möglichkeit,
  die Form von Fußnoten zu konfigurieren.%
}{%
  \IfThisCommonLabelBase{scrlttr2}{%
    Die Anweisungen zum Setzen von Fußnoten sind in jeder \LaTeX-Einführung,
    beispielsweise \cite{l2kurz}, zu finden. \KOMAScript{} bietet darüber
    hinaus aber auch noch die Möglichkeit, die Form der Fußnoten zu verändern.
    \iftrue % Umbruchoptimierung
      ...
      Auflistung von Verteilern oder ähnlichen typischen Elementen von Briefen
      zu vermeiden. Dies liegt in der Verantwortung des Anwenders.%
...
aneinander gereiht. Das in \DescRef{\ThisCommonLabelBase.cmd.multfootsep}%
\IndexCmd{multfootsep}\important{\DescRef{\ThisCommonLabelBase.cmd.multfootsep}}
...
rücken. Siehe\important{\DescRef{\ThisCommonLabelBase.option.footnote}} hierzu
...
\IfThisCommonLabelBase{scrextend}{ %
  ...
  vornehmen. Dazu kann obige Code-Zeile beispielsweise unmittelbar nach dem
