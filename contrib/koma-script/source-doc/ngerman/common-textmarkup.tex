...
\IfThisCommonLabelBase{scrlttr2}{}{%
  Neben der Wahl der Schriftart gehören dazu auch Befehle
...
\IfThisCommonLabelBaseOneOf{scrlayer-scrpage,scrjura,scrlayer-notecolumn}{%
  ...
  hoch\Index{Hochstellung} zu stellen, bietet \LaTeX{} erst seit Version
...
solche Anweisungen beschränken, mit denen wirklich nur ein Schriftattribut
umgeschaltet wird. In der Regel werden dies Befehle wie \Macro{normalfont},
\Macro{rmfamily}, \Macro{sffamily}, \Macro{ttfamily}, \Macro{mdseries},
\Macro{bfseries}, \Macro{upshape}, \Macro{itshape}, \Macro{slshape},
\Macro{scshape} oder einer der Befehle \Macro{Huge}, \Macro{huge},
...
\IfThisCommonLabelBaseOneOf{scrjura,scrlayer-notecolumn}{}{%
  ...
  \IfThisCommonLabelBase{scrlayer-scrpage}{und deren Voreinstellungen }{}%
  sind in %
  ...
  aufgelistet.%
  \IfThisCommonLabelBase{scrextend}{ %
    Allerdings werden davon in \Package{scrextend} nur die Elemente für den
    Dokumenttitel, den schlauen Spruch, die Fußnoten und die
    \DescRef{maincls.env.labeling}-Umgebung behandelt. Das Element
...
\IfThisCommonLabelBase{maincls}{\iftrue}{\csname iffalse\endcsname}
  \begin{Example}
    ...
    \DescRef{\ThisCommonLabelBase.fontelement.captionlabel} soll dieselbe Schriftart wie
    für \DescRef{\ThisCommonLabelBase.fontelement.descriptionlabel} verwenden. Das
...
\end{lstcode}
  ...
  \begin{desclist}
    ...
    \feentry{chapterprefix}{%
      Kapitelnummernzeile bei Einstellung
      \OptionValueRef{maincls}{chapterprefix}{true} oder
    ...
    \feentry{dictumtext}{%
      alternative Bezeichnung für \DescRef{\ThisCommonLabelBase.fontelement.dictum}}%
    \feentry{disposition}{%
    ...
    \feentry{labelingseparator}{%
      ...
      nach dem Element \DescRef{\ThisCommonLabelBase.fontelement.labelinglabel} (siehe
      \autoref{sec:maincls.lists}, \DescPageRef{maincls.env.labeling})}%
    \feentry{minisec}{%
    ...
    \feentry{sectionentrydots}{%
      ...
      \DescRef{\ThisCommonLabelBase.fontelement.sectionentrypagenumber} (nur bei
      \Class{scrartcl} verfügbar, siehe \autoref{sec:maincls.toc},
      \DescPageRef{maincls.cmd.tableofcontents})}%
    \feentry{sectionentrypagenumber}{%
      Seitenzahl des Inhaltsverzeichniseintrags der Ebene
      \DescRef{\ThisCommonLabelBase.cmd.section} abweichend vom Element
      \DescRef{\ThisCommonLabelBase.fontelement.sectionentry} (nur bei \Class{scrartcl}
      verfügbar, siehe \autoref{sec:maincls.toc},
      \DescPageRef{maincls.cmd.tableofcontents})}%
    \feentry{sectioning}{%
      alternative Bezeichnung für
    ...
    \IfThisCommonLabelBase{scrlttr2}{%
      ...
      \begin{desclist}
        ...
        \feentry{labelingseparator}{%
          ...
          \autoref{sec:scrlttr2.lists}, \DescPageRef{scrlttr2.env.labeling})}%
        \feentry{pagefoot}{%
          wird nach dem Element \DescRef{\ThisCommonLabelBase.fontelement.pageheadfoot}
        ...
        \feentry{toaddress}{Abweichung vom Element
          \DescRef{\ThisCommonLabelBase.fontelement.addressee} für die Anschrift (ohne
          Name) des Empfängers im Anschriftfeld
          (\autoref{sec:scrlttr2.firstpage},
          \DescPageRef{scrlttr2.variable.toaddress})}%
        \feentry{toname}{Abweichung vom Element
          \DescRef{\ThisCommonLabelBase.fontelement.addressee} für den Namen des
          Empfängers im Anschriftfeld (\autoref{sec:scrlttr2.firstpage},
