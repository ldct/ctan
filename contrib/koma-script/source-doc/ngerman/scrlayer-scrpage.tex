...
%
\begin{Example}
  Mit der Sternform von \DescRef{\LabelBase.cmd.lohead} und \DescRef{\LabelBase.cmd.rohead} lässt sich das
...
\end{lstcode}
  ...
  \DescRef{\LabelBase.cmd.lohead}. Ebenso ist die Lösung, um den Verlag auch auf diese Seite
...
%
\begin{Example}
  Mit der Sternform von \DescRef{\LabelBase.cmd.lofoot} und \DescRef{\LabelBase.cmd.rofoot} lässt sich das
  Beispiel aus der vorherigen Erklärung etwas verkürzen:
%
\begin{lstcode}
  \documentclass[twoside]{scrartcl}
...
\DescRef{\LabelBase.cmd.lohead}. Entsprechendes gilt für die Anweisungen des Fußes. In
...
Voreinstellung gewählt, die auch automatisch eingestellt wird, falls die
Option nicht angegeben ist und eine \KOMAScript-Klasse erkannt wurde. Dabei
werden für \PageStyle{scrheadings} im doppelseitigen Satz Kolumnentitel außen
im Kopf und Seitenzahlen außen im Fuß gesetzt. Im einseitigen Satz wird der
Kolumnentitel stattdessen mittig im Kopf und die Seitenzahl mittig im Fuß
platziert. Für die automatischen Kolumnentitel werden Groß- und
...
können mit den Anweisungen \DescRef{\LabelBase.cmd.setkomafont} und
