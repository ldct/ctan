...
Klasse mit \DescRef{\LabelBase.cmd.FamilyProcessOptions} eingreifen zu können. Dies ist mit
...
Mitglieder über \DescRef{\LabelBase.cmd.FamilyKeyState} einen Fehler zurückmeldet.
\begin{Example}
...
wäre es bei Verwendung von \DescRef{\LabelBase.cmd.FamilyOptions} notwendig, der Option mehrfach
...
möglich. Die Rückmeldung von Fehlerzuständen ist über diese Anweisung jedoch
ebenso wenig möglich, wie die Verwendung dieser Anweisung außerhalb der
...
\DescRef{\LabelBase.cmd.DefineFamilyKey}. Der Säumniswert für eine solche Option ist immer
\PValue{true}.
...
\end{lstcode}
  ...
  \DescRef{\LabelBase.cmd.DefineFamilyKey}, sondern entsprechend auch für \Macro{FamilyBoolKey}
  gilt.
...
direkt einen \PName{\LaTeX-Zähler} rerpäsentiert, dem unmittelbar ein
...
\DescRef{\LabelBase.cmd.FamilySetCounter} nur dadurch, dass nicht ein \LaTeX-Zähler auf einen
...
kann. Erkannte Fehler werden hingegen über \DescRef{\LabelBase.cmd.FamilyKeyStateUnknownValue}
signalisiert.
...
\Package{scrbase} konnte man über die Anweisung \Macro{FamilyElseValues}
