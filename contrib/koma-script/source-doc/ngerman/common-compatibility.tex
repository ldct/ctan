...
\IfThisCommonFirstRun{}{%
  ...
  wurde.\IfThisCommonLabelBase{scrlttr2}{ Allerdings existiert diese
    Möglichkeit bei \Class{scrlttr2} bereits seit Version~2.9t.}{} Falls Sie
  also \autoref{sec:\ThisCommonFirstLabelBase.compatibilityOptions}
...
\IfThisCommonLabelBaseOneOf{typearea,maincls}{%
  ...
  und Korrekturen am Paket zu Änderungen im Verhalten, inbesondere beim
...
\IfThisCommonLabelBase{typearea}{%
  ...
  \IfThisCommonLabelBase{maincls}{%
    ...
    \IfThisCommonLabelBase{scrlttr2}{%
      Version~2.9t besteht bei \Class{scrlttr2} }{%
...
Mit \OptionValue{version}{last} kann die jeweils neuste Version ausgewählt
werden. In diesem Fall wird also auf zukünftige Kompatibilität
