...
\IfThisCommonFirstRun{}{%
  ...
  \autoref{sec:\ThisCommonFirstLabelBase.options} geschrieben wurde. Falls
  Sie also \autoref{sec:\ThisCommonFirstLabelBase.options} bereits gelesen
...
\IfThisCommonLabelBase{scrlttr2}{Im Sinne der Abgeschlossenheit der Kapitel
  ...
  \IfThisCommonLabelBase{maincls}{bei den weiteren Kapitel überspringen.}{beim
    weiteren Studium der Anleitung dann überspringen.}%
} %
...
Werte sind dabei in der \PName{Werteliste} durch Komma voneinander getrennt.
...
\iffalse % Umbruchkorrektur
  ...
  \IfThisCommonLabelBaseOneOf{maincls,scrlttr2}{für Experten }{}%
  in \autoref{sec:scrbase.keyvalue},
  \DescPageRef{scrbase.cmd.FamilyOptions} zu finden.  \else
  %
