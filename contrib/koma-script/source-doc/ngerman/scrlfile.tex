...
\DescRef{\LabelBase.cmd.ReplaceInput} ersetzt werden. In diesem Fall würde \LaTeX{} eine
...
\end{Example}
Eine Lösung dieses Problems besteht nun darin, statt \DescRef{\LabelBase.cmd.ReplaceInput} eine
...
\PName{Stattdessencode} mehrfach ausgeführt wird, falls Sie versuchen, das
