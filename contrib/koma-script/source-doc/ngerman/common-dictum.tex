...
\IfThisCommonFirstRun{}{%
  ...
  \IfThisCommonLabelBase{scrextend}{%
    ...
    \DescRef{maincls.cmd.setpartpreamble} nicht definiert. Ob die verwendete
    Klasse eine entsprechende Anweisung bietet, ist der Anleitung zur
    jeweiligen Klasse zu entnehmen. %
  }{}%
...
(siehe \cite{latex:usrguide}) der Breite \Macro{dictumwidth} gesetzt. Dabei
ist \Macro{dictumwidth} keine Länge, die mit \Macro{setlength} gesetzt
wird. Es handelt sich um ein Makro, das mit \Macro{renewcommand} umdefiniert
werden kann. Vordefiniert ist \PValue{0.3333\Length{textwidth}}, also ein
Drittel der jeweiligen Textbreite. Die Box selbst wird mit der Anweisung
\Macro{raggeddictum} ausgerichtet. Voreingestellt ist dabei
...
Linie ist in \Macro{dictumrule} definiert. Es handelt sich dabei um ein
...
Makro erwartet schlicht den \PName{Urheber} als Argument. In der
...
\important{\DescRef{\ThisCommonLabelBase.fontelement.dictum}} definiert
